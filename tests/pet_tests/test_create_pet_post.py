...
from data.pet_create_payload import CORRECT_ONE_PET_PAYLOAD, CORRECT_THREE_PET_PAYLOAD, PET_PAYLOAD_EMPTY_FIELDS, \
    REQUIRED_FIELDS_EMPTY_PET_PAYLOAD, INCORRECT_STATUS_PET_PAYLOAD, LONG_ID_PET_PAYLOAD, INCORRECT_ID1_PET_PAYLOAD, INCORRECT_ID_PET_PAYLOAD
